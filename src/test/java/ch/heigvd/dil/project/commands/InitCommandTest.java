...
public class InitCommandTest {
    ...
    /**
     * When we create a new project, the project folder should be created. And the project should be initialized.
     * So we check that the project folder exists and some files are created.
     */
    @Test
